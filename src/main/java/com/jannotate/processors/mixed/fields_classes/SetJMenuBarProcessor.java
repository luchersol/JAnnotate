...
public class SetJMenuBarProcessor extends AbstractFieldAndClassProcessor<SetJMenuBar> {
    ...
    @Override
    protected void process(Field field, Object object, SetJMenuBar annotation) throws SevereException {
        try {
    ...
    @Override
    protected void process(Class<?> clazz, Object object, SetJMenuBar annotation) throws SevereException {
        try {
            JMenuBar jMenuBar = getFieldAs(annotation.value(), object, JMenuBar.class);
