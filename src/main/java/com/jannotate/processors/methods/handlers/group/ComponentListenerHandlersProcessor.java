...
@JProcessor
public class ComponentListenerHandlersProcessor extends AbstractGroupedListenerHandlerProcessor<ComponentListenerHandlerProcessor, ComponentListenerHandler, ComponentListenerHandlers> {
}
