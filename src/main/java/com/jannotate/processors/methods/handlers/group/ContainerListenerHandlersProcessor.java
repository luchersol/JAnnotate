...
@JProcessor
public class ContainerListenerHandlersProcessor extends AbstractGroupedListenerHandlerProcessor<ContainerListenerHandlerProcessor, ContainerListenerHandler, ContainerListenerHandlers> {
}
