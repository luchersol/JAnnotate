...
public class RequiresPackProcessor extends AbstractFieldAndClassProcessor<RequiresPack> {
    ...
    @Override
    public void process(Field field, Object object, RequiresPack annotation) throws LogException {
        processMethodInField(field, object, "pack");
    }

    @Override
    public void process(Class<?> clazz, Object object, RequiresPack annotation) throws LogException {
